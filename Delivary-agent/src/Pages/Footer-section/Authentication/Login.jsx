...
const Login = () => {
  return (
   <div 
      ...
      style={{
        backgroundImage: 'url(/bg-img/bg2.png)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat'
      }}
    >
      <h1 className=' text-center text-md-start mb-5 mb-md-0 monsieur-la-doulaise-regular' style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>Join with us <p>Empower the World</p></h1>
      ...
      <div className="position-relative my-5 my-md-0" style={{ width: '100%', maxWidth: '500px' }}>
        <form className='border m-3 p-4 p-md-5 bg-secondary rounded-1 bg-opacity-75'>          
          <h1 className='fs-5 text-white text-center p-3 text-decoration-underline'>Login Form</h1>
          {/* <div className="mb-3">
