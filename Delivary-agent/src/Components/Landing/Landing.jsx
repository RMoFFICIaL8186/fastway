...
const Landing = () => {
  ...
  // Mock function to simulate receiving an order
  const simulateOrderRequest = () => {
    ...
    setMapUrl('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929667.215013681!2d78.1183783718409!3d15.879410523924617!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3546f8ae93d47f%3A0x33d1bbbe95adcd83!2sAndhra%20Pradesh!5e0!3m2!1sen!2sin!4v1753717880301!5m2!1sen!2sin');
  };
  ...
  const handleReject = () => {
    ...
    // After rejection, set hasActiveOrder back to false after a delay
    setTimeout(() => {
  ...
  const verifyDelivery = () => {
    if (deliveryOtp === '5678') {
      ...
      setShowDeliveryConfirmation(false);
      // After delivery, set hasActiveOrder back to false after a delay
      setTimeout(() => {
        setHasActiveOrder(false);
      }, 2000);
    }
      ...
      <div className='container border m-2 p-2'>
        {hasActiveOrder ? (
          ...
          <div className="text-center p-5">
            <h2 className="dm-regular-italic mb-4">Waiting for order request...</h2>
            <button 
              className="btn btn-primary"
              onClick={simulateOrderRequest}
            >
              Simulate Order Request (Demo)
            </button>
            <div className="container mt-4">
              <h1 className='fs-3 amarante-regular text-center text-md-start'>Delivery Area Map</h1>
              <div className="section">
                <div className="ratio ratio-16x9">
                  <iframe 
                    src={mapUrl}
